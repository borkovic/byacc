...
#line 75 "err_inherit3.y"
	{ yyval.nlist = yystack.l_mark[0].nlist; }
#line 1215 "err_inherit3.tab.c"
break;
#line 1217 "err_inherit3.tab.c"
    default:
        break;
    }
    yystack.s_mark -= yym;
